  ...
  return (
    <div className="min-h-screen bg-orange-50 p-8">
      <div className="mx-auto max-w-7xl">
        <BrandBanner subtitle="Admin Class Page" textClassName="text-orange-900" subtextClassName="text-orange-700" className="mb-6" />
        <button
          type="button"
          onClick={onBack}
        ...
        {loading ? <p className="rounded-2xl border border-orange-200 bg-orange-50 px-4 py-3 text-sm text-orange-700">Loading class page...</p> : null}
            ...
            <section className="mt-8 grid gap-6 xl:grid-cols-2">
              <form className="rounded-3xl bg-white p-6 shadow-sm" onSubmit={handleAddStudent}>
                ...
                <div className="mt-6 space-y-4">
                  <input type="text" value={studentName} onChange={(event) => setStudentName(event.target.value)} placeholder="Student full name" className="w-full rounded-2xl border border-slate-200 px-4 py-3 outline-none focus:border-orange-500 focus:ring-4 focus:ring-orange-100" />
                  <input type="email" value={studentEmail} onChange={(event) => setStudentEmail(event.target.value)} placeholder="student@schoolerp.com" className="w-full rounded-2xl border border-slate-200 px-4 py-3 outline-none focus:border-orange-500 focus:ring-4 focus:ring-orange-100" />
                  <input type="password" value={studentPassword} onChange={(event) => setStudentPassword(event.target.value)} placeholder="Temporary password" className="w-full rounded-2xl border border-slate-200 px-4 py-3 outline-none focus:border-orange-500 focus:ring-4 focus:ring-orange-100" />
              ...
              <div className="rounded-3xl bg-white p-6 shadow-sm">
                ...
                <p className="mt-3 text-sm text-slate-500">Open a separate page to mark today's attendance for every student in this class.</p>
                ...
                <button
                  ...
                  className="mt-6 w-full rounded-2xl bg-orange-600 px-4 py-3 font-semibold text-white transition hover:bg-orange-700"
                >
              ...
              <form className="rounded-3xl bg-white p-6 shadow-sm" onSubmit={handleScheduleExam}>
                ...
                <div className="mt-6 space-y-4">
                  <input type="text" value={examSubject} onChange={(event) => setExamSubject(event.target.value)} placeholder="Exam subject" className="w-full rounded-2xl border border-slate-200 px-4 py-3 outline-none focus:border-orange-500 focus:ring-4 focus:ring-orange-100" />
                  <input type="date" value={examDate} onChange={(event) => setExamDate(event.target.value)} className="w-full rounded-2xl border border-slate-200 px-4 py-3 outline-none focus:border-orange-500 focus:ring-4 focus:ring-orange-100" />
                  <input type="time" value={examTime} onChange={(event) => setExamTime(event.target.value)} className="w-full rounded-2xl border border-slate-200 px-4 py-3 outline-none focus:border-orange-500 focus:ring-4 focus:ring-orange-100" />
                  <input type="text" value={examRoom} onChange={(event) => setExamRoom(event.target.value)} placeholder="Room" className="w-full rounded-2xl border border-slate-200 px-4 py-3 outline-none focus:border-orange-500 focus:ring-4 focus:ring-orange-100" />
                  <input type="number" min="1" value={examMaxMarks} onChange={(event) => setExamMaxMarks(event.target.value)} placeholder="Max marks" className="w-full rounded-2xl border border-slate-200 px-4 py-3 outline-none focus:border-orange-500 focus:ring-4 focus:ring-orange-100" />
                  <button type="submit" disabled={busyKey === 'exam'} className="w-full rounded-2xl bg-orange-600 px-4 py-3 font-semibold text-white transition hover:bg-orange-700 disabled:bg-orange-300">
                ...
                <div className="mt-6 h-96 space-y-3 overflow-y-scroll pr-2">
                  {orderedScheduledExams.length ? orderedScheduledExams.map((exam) => (
                    <button
                      ...
                      className="w-full rounded-2xl border border-slate-200 p-4 text-left transition hover:border-orange-300 hover:bg-orange-50"
                    >
              ...
              <form className="rounded-3xl bg-white p-6 shadow-sm" onSubmit={handleScheduleAssignment}>
                ...
                <div className="mt-6 space-y-4">
                  <input type="text" value={assignmentTitle} onChange={(event) => setAssignmentTitle(event.target.value)} placeholder="Assignment title" className="w-full rounded-2xl border border-slate-200 px-4 py-3 outline-none focus:border-orange-500 focus:ring-4 focus:ring-orange-100" />
                  <input type="text" value={assignmentSubject} onChange={(event) => setAssignmentSubject(event.target.value)} placeholder="Subject" className="w-full rounded-2xl border border-slate-200 px-4 py-3 outline-none focus:border-orange-500 focus:ring-4 focus:ring-orange-100" />
                  <input type="datetime-local" value={assignmentDeadline} onChange={(event) => setAssignmentDeadline(event.target.value)} className="w-full rounded-2xl border border-slate-200 px-4 py-3 outline-none focus:border-orange-500 focus:ring-4 focus:ring-orange-100" />
                  <button type="submit" disabled={busyKey === 'assignment'} className="w-full rounded-2xl bg-orange-600 px-4 py-3 font-semibold text-white transition hover:bg-orange-700 disabled:bg-orange-300">
              ...
              <form className="rounded-3xl bg-white p-6 shadow-sm xl:col-span-2" onSubmit={handlePostAnnouncement}>
                ...
                <div className="mt-6 space-y-4">
                  <input type="text" value={announcementTitle} onChange={(event) => setAnnouncementTitle(event.target.value)} placeholder="Announcement title" className="w-full rounded-2xl border border-slate-200 px-4 py-3 outline-none focus:border-orange-500 focus:ring-4 focus:ring-orange-100" />
                  <textarea value={announcementMessage} onChange={(event) => setAnnouncementMessage(event.target.value)} placeholder="Write announcement for the class" rows="4" className="w-full rounded-2xl border border-slate-200 px-4 py-3 outline-none focus:border-orange-500 focus:ring-4 focus:ring-orange-100" />
                ...
                <div className="mt-6 grid gap-4 lg:grid-cols-2">
                  {classroom.students.length ? classroom.students.map((student) => (
                    <button
                      ...
                      className="rounded-2xl border border-slate-200 p-4 text-left transition hover:border-orange-300 hover:bg-orange-50"
                    >
