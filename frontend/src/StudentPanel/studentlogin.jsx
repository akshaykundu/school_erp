...
export default function StudentLogin() {
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      if (!response.ok) {
        setError(data.message || 'Unable to login as student.');
        return;
      }
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_#dcfce7,_#f0fdf4_35%,_#d1fae5_65%,_#bbf7d0)] px-6 py-10">
          ...
          <section className="px-8 py-10 sm:px-12">
            <div className="mb-8">
              ...
              <p className="mt-2 text-sm text-slate-500">
                Only students added by a teacher can access this portal.
              </p>
            </div>
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <button
                ...
                className="w-full rounded-2xl bg-emerald-700 px-4 py-3 font-semibold text-white transition hover:bg-emerald-800 disabled:cursor-not-allowed disabled:bg-emerald-400"
              >
