...
export default function TeacherLogin({ onBack, onLogin }) {
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      if (!response.ok) {
        setError(data.message || 'Unable to login as teacher.');
        return;
      }

      setSuccess('Login successful. Opening teacher portal...');
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_#dbeafe,_#eff6ff_35%,_#e0e7ff_65%,_#c7d2fe)] px-6 py-10">
          ...
          <section className="px-8 py-10 sm:px-12">
            <div className="mb-8">
              ...
              <p className="mt-2 text-sm text-slate-500">
                Only teachers added by an admin can access this portal.
              </p>
            </div>
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              {isSubmitting ? (
                <p className="rounded-2xl border border-blue-200 bg-blue-50 px-4 py-3 text-sm text-blue-700">
                  Checking your teacher credentials...
                </p>
              ) : null}
